...
func NewScaleParameters(scaleFactor float64, items int, warehouses int, districtsPerWarehouse int, customersPerDistrict int, newOrdersPerDistrict int) (*ScaleParameters, error) {
	s := &ScaleParameters{
